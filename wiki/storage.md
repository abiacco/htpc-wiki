...
Reference the DiY case/drive lists below, and the example builds under the [Wiki Sample Builds](/r/htpc/wiki/sample-builds#wiki_nas.2Fmedia_server_builds) page for full-part builds that range from used OEM pre-builts to ultimate DiY  
